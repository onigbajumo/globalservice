                  ...
                  <div class="col-md-8 col-lg-6 col-xl-4 py-4 px-4 px-lg-5">
                    ...
                    <div class="text-center">
                      ...
                      <div>
                        ...
                        <a class="fs-sm fw-medium" href="{{ route('login') }}" >Sign In</a>
                      </div>
                    </div>
                    <!-- END Header -->
                    ...
                    @csrf
                      <div class="py-3">
                        <div class="mb-4">
                          <input type="text" class="form-control form-control-lg form-control-alt @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Username" autofocus>
                          @error('name')
                        ...
                        <div class="mb-4">
                          <input type="email" class="form-control form-control-lg form-control-alt @error('email') is-invalid @enderror" value="{{ old('email') }}" id="email" name="email" placeholder="Email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
