...
@section('content')
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">NIN <small>Information</small></h3>
            </div>
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                @foreach ($n_i_n_s as $items)
                  <tr>
                    <td class="text-center fs-sm">{{$items -> user_id}}</td>
                    ...
                    <td>
                      <span class="text-muted fs-sm">{{$items -> lastName}}</span>
                    </td>
                    ...
                    <ul class="nav-main nav-main-horizontal nav-main-hover ">
                      <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                          <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ url('/nin/' . $items->id )}}">
