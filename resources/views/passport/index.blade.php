...
@section('content')
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Passport <small>Information</small></h3>
            </div>
            <div class="block-content block-content-full">
              ...
              <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                @foreach ($passport as $pass)
                  <tr>
                    <td class="text-center fs-sm">{{$pass -> user_id}}</td>
                    <td class="fw-semibold fs-sm">
                       {{$pass -> firstName}}
                    </td>
                    <td class="d-none d-sm-table-cell fs-sm">
                    {{$pass ->email}}<span class="text-muted">@example.com</span>
                    </td>
                    <td>
                      <span class="text-muted fs-sm">{{$pass -> contactNumber}}</span>
                    </td>
                    ...
                    <ul class="nav-main nav-main-horizontal nav-main-hover ">
                      <li class="nav-main-item">
                        ...
                        <ul class="nav-main-submenu">
                          <li class="nav-main-item">
                            <a class="nav-main-link" href="{{ url('/passport/' . $pass->id )}}">
