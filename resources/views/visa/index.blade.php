...
@section('content')
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">Visa Application Table</h3>
            </div>
                ...
                @foreach ($visa as $item)
                  <tr>
                    ...
                    <td class="fw-semibold fs-sm">
                      <a href="be_pages_generic_profile.html">{{$item -> nationality}}</a>
                    </td>
                    <td class="d-none d-sm-table-cell fs-sm">
                    {{$item ->passport_type}}<span class="text-muted">@example.com</span>
                    </td>
                    <td>
                      <span class="text-muted fs-sm">{{$item -> created_at}}</span>
                    </td>
